...
void CCloudySkySample::Render(double deltaSeconds)
{
    ...
    if( m_PPAttribs.m_bEnableClouds )
    {
        ...
        RenderAttribs.fCurrTime = m_fCloudTime;
        RenderAttribs.bTiledMode = static_cast<CPUTCheckbox*>(pGUI->GetControl(ID_TILED_MODE_CHK))->GetCheckboxState() == CPUT_CHECKBOX_CHECKED;
...
{    
    ...
    */
    ...
    {
        CPUTCheckbox *pCheckBox = NULL;
        pGUI->CreateCheckbox( L"Tiled mode", ID_TILED_MODE_CHK, ID_MAIN_PANEL, &pCheckBox);
...

    {
        ...
        pSlider->SetScale( 500.0f, 10000.0f, 50 );
    ...
    (
        0.74648196f, 0.00000000f,   -0.66540575f,    0.00000000f,
        0.0030961374f, 0.99998915f,  0.0034733855f, 0.00000000f,
        0.66539854f, -0.0046530073f, 0.74647385f,  0.00000000f, 
        -95.160301f, 1250.9277f, -139.18567f,       1.0000000f
    );
    ...
    */ 
    ...
    pGUI->GetControl(ID_TILED_MODE_CHK)->SetEnable(m_pCloudsController->IsPSOrderingAvailable());
