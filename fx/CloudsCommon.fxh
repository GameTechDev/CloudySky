                                        ...
                                        out float fDensityLevel)
{
    ...
    fDensityLevel = exp2( (fDensityLevelCoord - (0.5 + 0.5/SRF_SCATTERING_IN_PARTICLE_LUT_DIM.w)) * SRF_SCATTERING_IN_PARTICLE_LUT_DIM.w  );
}
