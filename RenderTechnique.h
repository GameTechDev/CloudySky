...
public:
    ...
    HRESULT CreateGSWithSOFromFile       (LPCTSTR strFilePath, LPSTR strFunctionName, const D3D_SHADER_MACRO* pDefines, D3D11_SO_DECLARATION_ENTRY *pDecl, UINT NumDeclEntries, UINT *pStrides, UINT NumStrides, UINT RasterizedStream);
